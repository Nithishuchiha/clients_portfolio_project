...
const ServiceCategories = ({ showFilters = true }) => {
  const services = [
    {
      id: 1,
      icon: UiUXIcon,
      ...
      filters: ['All', 'UI Designs', 'UX Research'],
    },
    {
      id: 2,
  ...
  const [featuredServiceId, setFeaturedServiceId] = useState(1)
  ...
  const FilterComponent = (props) => {
    return (
      <div className={`${props.className} my-10 flex flex-wrap items-center justify-center gap-3`}>
    ...
    <section className="w-full py-4 md:py-12 lg:py-4">
      <div className="w-full rounded-lg flex flex-col items-center gap-6 bg-gray-bg border border-gray-bg p-6 md:p-8 lg:p-12">
        ...
        <div className="text-center mb-3">
          <span className="px-6 py-2 border border-black rounded-full text-sm" style={{letterSpacing: '2px', fontWeight: '500'}}>
            SERVICES
          </span>
        </div>
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                />
                <h3 className="text-lg text-center font-semibold mb-1">{service.title}</h3>
                <p
              ...
              {isActive && showFilters && <FilterComponent className="flex lg:hidden" />}
              </>
            )
          })}
        </div>
